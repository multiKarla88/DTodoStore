        ...
        <div class="col-12">
          ...
          <div class="user-wrapper">
            ...
            <div class="user-content">
              <h2 class="page-header">Ver categoria</h2>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10"  style="padding-bottom:25px;">
                        ...
                        <input type="text" class="form-control" id="nombre" value="<?php echo "Moda" ?>" disabled>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10"  style="padding-bottom:25px;">
                        <!-- Aquí traera la el nombre del usuario para cambiarla -->
                        <input type="text" class="form-control" id="nombre" value="<?php echo "Categoria de ropa para dama hombre" ?>" disabled>
                      </div>
                    </div>
                    ...
                    <a href="#" class="btn btn-primary" style="float:right;">Regresar</a>
                  </form>
                </div>
              </div>
