<footer>
  <hr >
  <div class="container">
    <!-- Se trataran las secciones como columnas, en total se suman 12 espacios. 4x3=12-->
    <div class="row">

      <!--Seccion de servicio al cliente-->
      <div class="col-md-4 links wrapper">
        <div class="page-header">Servicio al cliente</div>
        <ul>
          <li>
            <a href="#">
          ...
          <li>
            <a href="terminosYCondiciones.php">
    ...
    <!--Seccion de Informacion D-Todo Almacenes-->
    <div class="col-md-4 links wrapper">
      <div class="page-header ">
        D-Todo Almacenes
      </div>
      <ul>
        <li><img src="img/logo Dtodo.png" class="store-image" alt="De Todo Logo" /></li>
        <li>
