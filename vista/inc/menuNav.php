      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <!--Sub-item Dama-->
            <li><a href="./product.php?Catprod=1" class="trsn nav-link" title="Dama">Dama</a></li>
            
            <!--Sub-item Caballero-->
            <li><a href="./product.php?Catprod=2" class="trsn nav-link" title="Caballero">Caballero</a></li>
            
            <!--Sub-item Niño-->
            <li><a href="./product.php?Catprod=3" class="trsn nav-link" title="Niño">Niño</a></li>
            
            <!--Sub-item Niña-->
            <li><a href="./product.php?Catprod=4" class="trsn nav-link" title="Niña">Niña</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="./product.php?Catprod=6" class="trsn nav-link" title="Muebles de sala">Muebles de sala</a></li>

            <!--Sub-item muebles de cocina-->
            <li><a href="./product.php?Catprod=7" class="trsn nav-link" title="Muebles de cocina">Muebles de cocina</a></li>
            
            <!--Sub-item muebles de comedor-->
            <li><a href="./product.php?Catprod=8" class="trsn nav-link" title="Muebles de comedor">Muebles de comedor</a></li>
            
            <!--Sub-item muebles de dormitorio-->
            <li><a href="./product.php?Catprod=9" class="trsn nav-link" title="Muebles de dormitorio">Muebles de dormitorio</a></li>

            <!--Sub-item muebles de oficina-->
            <li><a href="./product.php?Catprod=10" class="trsn nav-link" title="Muebles de oficina">Muebles de oficina</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <!--Sub-item sala-->
            <li><a href="./product.php?Catprod=11" class="trsn nav-link" title="Sala">Sala</a></li>
            
            <!--Sub-item cocina-->
            <li><a href="./product.php?Catprod=12" class="trsn nav-link" title="Cocina">Cocina</a></li>
            
            <!--Sub-item dormitorio-->
            <li><a href="./product.php?Catprod=13" class="trsn nav-link" title="Dormitorio">Dormitorio</a></li>
            
            <!--Sub-item baño-->
            <li><a href="./product.php?Catprod=14" class="trsn nav-link" title="Baño">Baño</a></li>

            <!--Sub-item decoracion-->
            <li><a href="./product.php?Catprod=15" class="trsn nav-link" title="Decoracion">Decoracion</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="./product.php?Catprod=16" class="trsn nav-link" title="Refrigeradoras">Refrigeradoras</a></li>
            
            <!--Sub-item cocina-->
            <li><a href="./product.php?Catprod=17" class="trsn nav-link" title="Cocina">Cocina</a></li>
            
            <!--Sub-item lavadoras-->
            <li><a href="./product.php?Catprod=18" class="trsn nav-link" title="Lavadoras">Lavadoras</a></li>
            
            <!--Sub-item secadoras-->
            <li><a href="./product.php?Catprod=19" class="trsn nav-link" title="Secadoras">Secadoras</a></li>

            <!--Sub-item centro de lavado-->
            <li><a href="./product.php?Catprod=20" class="trsn nav-link" title="Centro de lavado">Centro de lavado</a></li>

            <!--Sub-item aires acondicionados-->
            <li><a href="./product.php?Catprod=21" class="trsn nav-link" title="Aires acondicionados">Aires acondicionados</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <!--Sub-item microondas-->
            <li><a href="./product.php?Catprod=22" class="trsn nav-link" title="Microondas">Microondas</a>
          
          </li>
            
            <!--Sub-item hornos tostadores-->
            <li><a href="./product.php?Catprod=23" class="trsn nav-link" title="Hornos Tostadores">Hornos Tostadores</a></li>
            
            <!--Sub-item licuadoras-->
            <li><a href="./product.php?Catprod=24" class="trsn nav-link" title="Licuadoras">Licuadoras</a></li>
            
            <!--Sub-item cafeteras-->
            <li><a href="./product.php?Catprod=25" class="trsn nav-link" title="Cafeteras">Cafeteras</a></li>

            <!--Sub-item tostadoras-->
            <li><a href="./product.php?Catprod=26" class="trsn nav-link" title="Tostadoras">Tostadoras</a></li>

            <!--Sub-item batidoras-->
            <li><a href="./product.php?Catprod=27" class="trsn nav-link" title="Batidoras">Batidoras</a></li>

            <!--Sub-item Wafleras Grill y sandwich-->
            <li><a href="./product.php?Catprod=28" class="trsn nav-link" title="Wafleras Grill y sandwich">Wafleras Grill y sandwich</a></li>

            <!--Sub-item olla arroceras-->
            <li><a href="./product.php?Catprod=29" class="trsn nav-link" title="Ollas arroceras">Ollas arroceras</a></li>

            <!--Sub-item teteras-->
            <li><a href="./product.php?Catprod=30" class="trsn nav-link" title="Teteras">Teteras</a></li>

            <!--Sub-item proceador para picado-->
            <li><a href="./product.php?Catprod=31" class="trsn nav-link" title="Procesador para picado">Procesador para picado</a></li>

            <!--Sub-item extractos de jugo-->
            <li><a href="./product.php?Catprod=32" class="trsn nav-link" title="Extractores de jugo">Extractores de jugo</a></li>

            <!--Sub-item planchas de ropa-->
            <li><a href="./product.php?Catprod=33" class="trsn nav-link" title="Planchas de ropa">Planchas de ropa</a></li>

            <!--Sub-item aspiradoras-->
            <li><a href="./product.php?Catprod=34" class="trsn nav-link" title="Aspiradores">Aspiradores</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="./product.php?Catprod=35" class="trsn nav-link" title="Computadoras">Computadoras</a></li>
            
            <!--Sub-item telefonos-->
            <li><a href="./product.php?Catprod=36" class="trsn nav-link" title="Telefonos">Telefonos</a></li>
            
            <!--Sub-item pantallas-->
            <li><a href="./product.php?Catprod=37" class="trsn nav-link" title="Pantallas">Pantallas</a></li>
            
            <!--Sub-item audio y video-->
            <li><a href="./product.php?Catprod=38" class="trsn nav-link" title="Audio y video">Audio y video</a></li>

            <!--Sub-item smartwatch-->
            <li><a href="./product.php?Catprod=39" class="trsn nav-link" title="Smartwatch">Smartwatch</a></li>

            <!--Sub-item camaras-->
            <li><a href="./product.php?Catprod=40" class="trsn nav-link" title="Camaras">Camaras</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="./product.php?Catprod=41" class="trsn nav-link" title="Computadoras" role="tab" data-toggle="tab">Maquillaje para rostro</a></li>


      
            
            <!--Sub-item maquillaje para ojos-->
            <li><a href="./product.php?Catprod=42" class="trsn nav-link" title="Maquillaje para ojos">Maquillaje para ojos</a></li>
            
            <!--Sub-item labiales-->
            <li><a href="./product.php?Catprod=43" class="trsn nav-link" title="Labiales">Labiales</a></li>
            
            <!--Sub-item cuidado de piel-->
            <li><a href="./product.php?Catprod=44" class="trsn nav-link" title="Cuidado de piel">Cuidado de piel</a></li>

            <!--Sub-item cuidado de cabello-->
            <li><a href="./product.php?Catprod=45" class="trsn nav-link" title="Cuidado de cabello">Cuidado de cabello</a></li>

            <!--Sub-item baño y ducha-->
            <li><a href="./product.php?Catprod=46" class="trsn nav-link" title="Baño y ducha">Baño y ducha</a></li>

            <!--Sub-item uñas-->
            <li><a href="./product.php?Catprod=47" class="trsn nav-link" title="Uñas">Uñas</a></li>

            <!--Sub-item fragancias-->
            <li><a href="./product.php?Catprod=48" class="trsn nav-link" title="Fragancias">Fragancias</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <!--Sub-item niños-->
            <li><a href="./product.php?Catprod=49" class="trsn nav-link" title="Niños">Niños</a></li>
            
            <!--Sub-item niñas-->
            <li><a href="./product.php?Catprod=50" class="trsn nav-link" title="Niñas">Niñas</a></li>
