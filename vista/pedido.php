    ...
    <section id="container-pedido">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div id="form-compra">
                        <form action="procesos/confirmcompra.php" method="post" role="form" class="FormCatElec" data-form="save">
                            <?php
                                if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
                                    ...
                                    echo '
                                        ...
                                        <p>
                                            ...
                                            y contraseña con la cual te registraste en <span class="tittles-pages-logo">DTodo Almacenes</span>.
                                        </p>
                                        <br>
